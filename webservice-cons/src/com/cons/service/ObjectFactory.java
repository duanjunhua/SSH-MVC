 ...
 * generated in the com.cons.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _TransWordsResponse_QNAME = new QName("http://prov.com/", "transWordsResponse");
    private final static QName _TransWords_QNAME = new QName("http://prov.com/", "transWords");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.cons.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://prov.com/", name = "transWordsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://prov.com/", name = "transWords")
