 ...
 * 
 */
@WebServiceClient(name = "FunctionService", targetNamespace = "http://prov.com/", wsdlLocation = "http://localhost:9100/Service/Function?wsdl")
    ...
    extends Service
{
    ...
    private final static QName FUNCTIONSERVICE_QNAME = new QName("http://prov.com/", "FunctionService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9100/Service/Function?wsdl");
    ...
    public Function getFunctionPort() {
        return super.getPort(new QName("http://prov.com/", "FunctionPort"), Function.class);
    }
    ...
    public Function getFunctionPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://prov.com/", "FunctionPort"), Function.class, features);
    }
